    ...
    <>
      <header className="fixed top-0 left-0 right-0 z-50 bg-white border-b border-gray-100">
        <div className="container-main relative">
          ...
          <div className="py-4 px-4 lg:px-6 xl:px-8">
            <div className="flex items-center justify-between">
              {/* Logo */}
              <Link
                href="/"
                className="inline-flex items-center h-10 hover:opacity-80 transition-opacity"
                            ...
                            <div className="bg-white rounded-lg shadow-lg border border-gray-100 py-2 min-w-[220px]">
                              ...
                              {item.dropdown.map((dropdownItem) => (
                                <Link
                                  ...
                                  className="block px-4 py-2 text-sm font-medium text-gray-700 hover:bg-gray-50 hover:text-emerald-600 transition-colors"
              ...
              <button
                ...
                className="xl:hidden flex items-center justify-center w-11 h-11 text-gray-700"
