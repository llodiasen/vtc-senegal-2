    ...
    <main className="min-h-screen bg-gray-50">
      ...
      <div className="bg-white border-b">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <Link
            href="/"
            className="inline-flex items-center gap-2 text-sm font-medium text-gray-600 hover:text-emerald-600 transition-colors mb-4"
          >
            ...
            <div key={index} className="bg-white rounded-lg shadow-sm p-6">
              ...
              <ul className="space-y-3">
                {category.questions.map((question, qIndex) => (
                  <li key={qIndex}>
                    <button className="text-left text-gray-700 hover:text-emerald-600 transition-colors">
                      {question}
                    </button>
                  </li>
                ))}
