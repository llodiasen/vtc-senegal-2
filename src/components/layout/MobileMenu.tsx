        ...
        <nav className="flex flex-col h-full" aria-label="Navigation mobile">
          <div className="flex-1 px-6 py-8 space-y-8">
            ...
            <Link
              href="/"
              onClick={onClose}
              className="inline-flex items-center justify-start pb-6 border-b border-gray-800"
                        ...
                        <div className="mt-4 ml-0 space-y-4">
                          {item.dropdown.map((dropdownItem) => (
                            <Link
                              ...
                              onClick={onClose}
                              className="block text-xl font-medium text-white hover:text-secondary-400 transition-colors relative after:absolute after:bottom-0 after:left-0 after:w-full after:h-px after:bg-current after:scale-x-0 after:origin-left after:transition-transform hover:after:scale-x-100"
                            >
                              {dropdownItem.label}
                            </Link>
                          ))}
            ...
            <div className="sm:hidden space-y-4 pt-6 border-t border-gray-800">
              ...
              >
                <svg className="w-5 h-5 mt-1" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
